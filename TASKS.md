...
after the M3 production build is ready**, the steward + Hee-Lee Oss governance declare **"Publicly Shipped
...
```json
{
  ...
  "resources": [
    "C:\\code\\hee-lee-oss\\planning\\projects\\oer-science-labs\\PLAN.md",
...
> Auto-generated by Hee-Lee Oss task-decomposition on 2026-06-29. Seed: `oer-science-labs-arch-001` (committed). All other task files generated from the backlog above.
